...
PotreeArguments parseArguments(int argc, char **argv){
	...
	args.addArgument("output-attributes,a", "can be any combination of RGB, INTENSITY, CLASSIFICATION, GPS_TIME, RTK_POSE, RTK_ORIENT, DUAL_PLUS_CONFIDENCE, LATITUDE, and LONGITUDE. Default is RGB.");
